...
def class_list(request, teacher_id=None):
    ...
    # Allow students, teachers, and professors to view the class list
    teacher = None
    if user_profile.employee_type in ['teacher', 'professor']:
        teacher = get_object_or_404(TeacherPersonalInfo, address__userprofile=user_profile) if not teacher_id else get_object_or_404(TeacherPersonalInfo, id=teacher_id)
