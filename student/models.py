    ...
    def save(self, *args, **kwargs):
        ...
        if not self.class_info or not self.session_info:
            try:
                ...
                if user_profile.is_student:  # Ensure user profile is a student
                    self.class_info = user_profile.student_class  # Assuming the user profile has these fields
                    self.session_info = user_profile.student_session  # Assuming the user profile has these fields
            except UserProfile.DoesNotExist:
                pass  # Handle the case if userprofile is not found
