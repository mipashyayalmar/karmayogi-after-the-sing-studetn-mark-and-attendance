...
from .models import (
    ...
    EmployeeJobInfo, ExperienceInfo, PersonalInfo,EmployeeMessage
)
...
class EmployeeMessageAdmin(admin.ModelAdmin):
    list_display = ['employee', 'sender', 'message_text', 'created_at']
    search_fields = ['message_text', 'sender__user__username', 'employee__name']
